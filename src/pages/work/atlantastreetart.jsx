    ...
    <div className="wrapper">
      ...
      <div className="col4">
        ...
        <p>
          ...
          designs were on the right path. After this, I took the critiques from the tests and
          developed a hi-fidelity prototype with Sketch and InVision. Once we had a full design, we
        ...
        <p>
          Keep the client happy. As the originator of the idea for the project, it was important for
          our group to ensure that the client was satisfied with the progress our team was making.
          This meant we had to hold biweekly meetings to show our user stories, design ideas, and
          our final implementation.
        </p>
        <p>
          Seek help early and often. While our whole team did learn a lot throughout the creation of
          the app, we definitely encountered obstacles along the way. If a team member was having
          issues, it was important for them to bring the problem to the group so that other members
          could help.
        </p>
      </div>
    </div>
